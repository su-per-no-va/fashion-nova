...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(
        ...
        String accessToken =
            jwtUtil.generateToken(user.getUserName(), ACCESS_TOKEN_EXPIRATION, ACCESS_TOKEN_TYPE);
        String refreshToken =
            jwtUtil.generateToken(user.getUserName(), REFRESH_TOKEN_EXPIRATION, REFRESH_TOKEN_TYPE);
