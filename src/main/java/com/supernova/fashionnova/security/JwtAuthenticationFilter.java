...
import static com.supernova.fashionnova.security.JwtConstants.REFRESH_TOKEN_HEADER;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if ("application/json".equals(request.getContentType())) {
            try {
                ...
                //확인용 로그
                log.info("Received login request: " + loginRequestDto.getUserName() + "     " + loginRequestDto.getPassword());
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String accessToken = jwtUtil.generateToken(user.getUserName(),ACCESS_TOKEN_EXPIRATION,ACCESS_TOKEN_TYPE);
        String refreshToken = jwtUtil.generateToken(user.getUserName(),REFRESH_TOKEN_EXPIRATION, REFRESH_TOKEN_TYPE);
