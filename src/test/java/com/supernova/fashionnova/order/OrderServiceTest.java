...
class OrderServiceTest {
    ...
    void setUp() {
        ...
        orderService = Mockito.spy(
            new OrderService(cartRepository, ordersRepository, orderDetailRepository));
    ...
    void createOrder() {
        ...
        doReturn(mockedOrderDetails).when(orderService)
            .createOrderDetail(anyList(), any(User.class), any(Order.class));
        ...
        when(orderDetailRepository.findFirstByOrderIdOrderByProductNameAsc(
            order.getId())).thenReturn(
        ...
        verify(orderDetailRepository, times(1)).findFirstByOrderIdOrderByProductNameAsc(
            order.getId());
